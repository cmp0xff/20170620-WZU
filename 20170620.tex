...
{My Understanding of \cite{Wang_2017}}

\subtitle{An Attempt to Avoid the Old $\varLambda$ Problem}
...
used by %\citeauthor{HAWKING1974}
, and the \alert{thermal equilibrium state} of 
