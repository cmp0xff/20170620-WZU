...
{An Introduction to \cite{Wang_2017}}

\subtitle{An Attempt to Avoid the Old Problem of Cosmological Constant}
...
\item \citeauthor{Wang_2017} consider vacuum energy \alert{density} instead, 
...
\rho^\text{vac}_\text{eff} = \rho^\text{vac} + \frac{\lambda_\text{b}}{8\pp\nG}.
\end{align}
\end{itemize}
